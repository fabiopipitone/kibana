...
export async function runDockerGenerator(
  ...
  if (flags.baseImage === 'wolfi')
    baseImageName =
      'docker.elastic.co/wolfi/chainguard-base:latest@sha256:792313d45d114da11e169252586f76a79ff20248c7af4283f11b94bff7f1aed7';
  ...
  if (flags.fips) {
    imageFlavor += '-fips';
    baseImageName =
      'docker.elastic.co/wolfi/chainguard-base-fips:latest@sha256:7b18967a1329291d113228149b97382406f039171c6537b1afa4067701a6ba9e';
  }
